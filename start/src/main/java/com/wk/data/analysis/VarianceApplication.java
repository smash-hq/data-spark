package com.wk.data.analysis;

import com.wk.data.spark.service.analysis.executor.impl.VarianceServiceImpl;
...
public class VarianceApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            SpringApplication.run(VarianceApplication.class, args);
        } catch (Exception e) {
            status = 1;
        } finally {
            System.exit(status);
    ...
    public void run(String... args) throws Exception {
        ...
        new VarianceServiceImpl().analysis(args);
    }
}