...
public class DataSplitApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            SpringApplication.run(DataSplitApplication.class, args);
        } catch (Exception e) {
            status = 1;
            throw e;
        } finally {
    ...
    public void run(String... args) throws Exception {
        System.err.println("数据拆分的任务ID:" + Arrays.toString(args));
        governService.startSplitData(args);
    }
}