...
/**
 * @program: data-etl
 * @description: 字符串常用格式校验
 * @author: gwl
 * @create: 2021-07-23 17:40
 **/
public class ValidateUtil {
    ...
    public static boolean isDateTimeStr(String str) {
        String reg = "^(([1-9][0-9]{3})|([0-9]{2}))([-./]|)(([0][1-9])|([1][0-2]))([-./]|)(([0][1-9])|([1-2][0-9])|([3][0-1]))" +
    ...
    public static void main(String[] args) {
        System.err.println(isTimeStr("0023 02"));
        String str = "2012-1212";
        System.err.println(isDateStr(str));
        System.err.println(isDateTimeStr("20201212010245"));
    }
