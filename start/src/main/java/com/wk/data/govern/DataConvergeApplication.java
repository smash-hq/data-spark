...
public class DataConvergeApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        System.err.println("数据归并的任务ID:" + Arrays.toString(args));
        governService.startConvergeData(args);
    }
}